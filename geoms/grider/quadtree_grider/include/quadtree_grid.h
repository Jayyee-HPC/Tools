#ifndef __QUADTREE_GRID_H_INCLUDED__
#define __QUADTREE_GRID_H_INCLUDED__
...
{
	public:
	Quadtree_Grid(int cells, const geos::geom::Envelope *universe, std::list<const geos::geom::Envelope*>* basis)
	{
		num_cells = cells;
	...
	Quadtree_Grid(int cells, const geos::geom::Envelope *universe, std::list<std::pair<const geos::geom::Envelope*, ulong> >* basis)
	{
		num_cells = cells;
	...
	Quadtree_Grid(int cells, const geos::geom::Envelope *universe, std::list<std::pair<geos::geom::Coordinate*, ulong > > * basis)
	{
		num_cells = cells;
		grid_cells_with_candidates_num = NULL;
...
#endif //ndef __QUADTREE_GRID_H_INCLUDED__

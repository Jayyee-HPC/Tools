...
int Quadtree_Grid :: partition(std::list<const geos::geom::Envelope*>* basis, const geos::geom::Envelope *universe)
{
...
int Quadtree_Grid :: partition_to_4cells(std::list<const geos::geom::Envelope*>* basis, const geos::geom::Envelope * env)
{
...
ulong Quadtree_Grid :: get_num_geoms_in_cell(std::list<const geos::geom::Envelope*>* basis, const geos::geom::Envelope* env)
{
	ulong num_pairs = 0;
	ulong counter = 0;
...
void Quadtree_Grid :: build_rtree_index(std::list<std::pair<geos::geom::Coordinate*, ulong>>* basis)
{
...
int Quadtree_Grid :: partition_using_coords_weight(std::list<std::pair<geos::geom::Coordinate*, ulong>>* basis, const geos::geom::Envelope *universe)
{
...
int Quadtree_Grid :: partition_to_4cells_using_coords_weight(std::list<std::pair<geos::geom::Coordinate*, ulong>>* basis, const geos::geom::Envelope* env)
{
	std::list<const geos::geom::Envelope*>* list_envs= new std::list<const geos::geom::Envelope*>();
...
ulong Quadtree_Grid :: get_complexity_for_cell(std::list<std::pair<geos::geom::Coordinate*, ulong>>* basis, const geos::geom::Envelope* env)
{
	ulong complexity = 0;
...
void Quadtree_Grid :: build_rtree_index(std::list<std::pair<const geos::geom::Envelope*, ulong>>* basis)
{
...
int Quadtree_Grid :: partition_using_envs_weight(std::list<std::pair<const geos::geom::Envelope*, ulong>>* basis, const geos::geom::Envelope *universe)
{
	grid_cells_with_candidates_weight->push_back(std::pair<const geos::geom::Envelope*, ulong>(universe, MAX_SIZE));
...
int Quadtree_Grid :: partition_to_4cells_using_envs_weight(std::list<std::pair<const geos::geom::Envelope*, ulong> >* basis, const geos::geom::Envelope * env)
{
	std::list<const geos::geom::Envelope*>* list_envs= new std::list<const geos::geom::Envelope*>;
	double min_x = env->getMinX();
	double min_y = env->getMinY();
...
ulong Quadtree_Grid :: get_complexity_for_cell(std::list<std::pair<const geos::geom::Envelope*, ulong>>* basis, const geos::geom::Envelope* env)
{
	ulong complexity = 0;

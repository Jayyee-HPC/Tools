...
//~/test/mpich/build/_inst/bin/mpicxx -o prog  -std=c++17 put_get_2processes.cpp
//~/test/mpich/build/_inst/bin/mpirun -np 2 ./prog
...
int main(int argc, char ** argv)
{
	...
	std::cout<<getBuf[0]<<" "<<getBuf[1]<<std::endl;
